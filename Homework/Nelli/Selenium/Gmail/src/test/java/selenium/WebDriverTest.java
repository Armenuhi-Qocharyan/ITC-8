...
public class WebDriverTest {
    ...
    public void registerGmail() throws InterruptedException, NullPointerException {
        ...
        driver.findElement(By.xpath("//*[@id='Passwd']")).sendKeys("testSelenium1");
        driver.findElement(By.xpath("//*[@id='PasswdAgain']")).sendKeys("testSelenium1");
        driver.findElement(By.xpath("//*[@id='BirthDay']")).sendKeys("29");
        driver.findElement(By.xpath("//*[@id='BirthYear']")).sendKeys("1997");
        ...
        driver.findElement(By.xpath("//*[@id='RecoveryEmailAddress']")).sendKeys("nelli.melkonyan.97@mail.ru");
