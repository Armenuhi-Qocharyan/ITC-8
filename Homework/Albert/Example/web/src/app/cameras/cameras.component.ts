...
export class CamerasComponent implements OnInit {
  ...
  constructor(private http:Http, private camerasService:CamerasService, private authenticationService:AuthenticationService, private _cookieService:CookieService) {
  } 
