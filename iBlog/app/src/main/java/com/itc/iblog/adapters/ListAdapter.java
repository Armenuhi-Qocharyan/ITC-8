            ...
            if (!file.exists()) {
                    ...
                    pathReference.getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
                        ...
                        public void onSuccess(byte[] bytes) {
                            ...
                            holder.postImage.setImageBitmap(Bitmap.createScaledBitmap(bmp, 300, 300, false));
                ...
                holder.postImage.setImageBitmap(Bitmap.createScaledBitmap(bitmap, 300, 300, false));
                holder.postImage.setVisibility(View.VISIBLE);
            }
